...
export class WalletNotificationService {
    ...
    async sendOperationNotification(from: any, to: any, amount: number, operationType: string) {
        const emailData = {
    ...
    async sendBalanceUpdateNotification(wallet: any, previousBalance: number, newBalance: number) {
        const emailData = {
