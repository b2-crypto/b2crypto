export enum PomeloEnum {
  ...
  POMELO_WHITELISTED_HEADER_FORWARDED = 'x-forwarded-for',
  POMELO_WHITELISTED_HEADER_REAL = 'x-real-ip',
  POMELO_WHITELISTED_IPS_CHECK_ON = 'ON',
  POMELO_WHITELISTED_IPS_CHECK_OFF = 'OFF',
}
