  ...
  implements IntegrationIdentityInterface
{
  ...
  async generateUrlApplicant(
    ...
    try {
      ...
      const issueTokenPath = `/resources/sdkIntegrations/levels/${issueTokenDto.levelName}/websdkLink?ttlInSecs=${issueTokenDto.ttlInSecs}&externalUserId=${issueTokenDto.userId}`;
